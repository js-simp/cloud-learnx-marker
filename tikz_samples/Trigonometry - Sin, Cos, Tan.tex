...
\begin{tikzpicture}[scale=1, transform shape]
    ...
    \pic [draw, "$30^{\circ}$", angle eccentricity=1.5, angle radius=0.6cm] {angle = C--B--A};
...
\begin{tikzpicture}[scale=1, transform shape]
    ...
    \pic [draw, "$15^{\circ}$", angle eccentricity=1.5, angle radius=0.6cm] {angle = C--B--A};
...
\begin{tikzpicture}[scale=1, transform shape]
    ...
    % Draw the angles
    \draw pic[draw, angle radius=2.5mm] {right angle=C--A--B};
    \pic [draw, "$50^{\circ}$", angle eccentricity=1.7, angle radius=0.6cm] {angle = C--B--A};
    ...
    % Place the labels with smaller font size
    \draw (A) -- (B) node[midway, below left] {11cm};
...
\begin{tikzpicture}[scale=1, transform shape]
    ...
    \pic [draw, "$40^{\circ}$", angle eccentricity=1.7, angle radius=0.6cm] {angle = A--B--C};
...
\begin{tikzpicture}[scale=1, transform shape]
    ...
    \pic [draw, "$123^{\circ}$", angle eccentricity=1.7, angle radius=0.6cm] {angle = B--C--D};
...
\begin{tikzpicture}[scale=1, transform shape]
    ...
    \pic [draw, "$10^{\circ}$", angle eccentricity=1.7, angle radius=0.6cm] {angle = C--A--B};
...
\begin{tikzpicture}[scale=1, transform shape]
    ...
    % Draw the angles
    \draw pic[draw, angle radius=2.5mm] {right angle=A--C--B};
    \pic [draw, "$30^{\circ}$", angle eccentricity=1.7, angle radius=0.6cm] {angle = C--D--B};
    ...
    % Place the labels with smaller font size
    \draw (A) -- (B) node[midway, below left] {$2x$};
    \draw (B) -- (D) node[midway, below right] {$3x$};
