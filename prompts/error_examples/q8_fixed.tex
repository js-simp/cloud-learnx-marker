\begin{question}
\noindent Shape $A$ and shape $B$ are drawn on the grid. P,Q,R are the vertices of shape A, and the corresponding points of the image B are P', Q', and R'. 
...
\begin{tikzpicture}[scale=0.75, transform shape]
    ...
    %label vertices of shape A
    \node[left] at (A1) {$P$};
    \node[above] at (A2) {$Q$};
    \node[right] at (A3) {$R$};

    % Shape B: rotation about (0,0) by 180 degrees
